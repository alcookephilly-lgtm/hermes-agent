...
def compress_context(
    ...
    *,
    ...
    # resulting checkpoint can preserve external continuity evidence.
    memory_compression_context = ""
    if agent._memory_manager:
        try:
            memory_compression_context = agent._memory_manager.on_pre_compress(messages) or ""
            if not isinstance(memory_compression_context, str):
                memory_compression_context = str(memory_compression_context)
        except Exception:
            memory_compression_context = ""
    ...
    messages_for_compression = list(messages or [])
